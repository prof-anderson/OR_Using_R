...
description: This book introduces optimization using R. The current focus is on linear
  and mixed integer programming but may expand in the future.  It does not presume
  R fluency and teaches some R along the way but does not aim to fully teach R.
