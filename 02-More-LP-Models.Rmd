...
We could further generalize this by instead of hard coding the number of products, defining the number of products and resources as NProd and NResources respectively.  We can then rewrite the above formulation as the following
...
### Ex2: Formulate an Explict Transportation Model
...
### Formulate a Generalized Transportation Model 
...
### Converting a 3 Variable Model to Standard Form
...
$$
 ...
 \begin{aligned}
    ...
    \text{subject to } & Profit=20*Chairs+10*Desks+16*Tables \\
                       & 6*Chairs+3*Desks+4*Tables +Slack_1 = 2000 \\
                       & 8*Chairs+4*Desks+4*Tables +Slack_2 = 2000 \\
                       & 6*Chairs+3*Desks+8*Tables+Slack_3 = 1440 \\
                       & 40*Chairs+20*Desks+25*Tables  +Slack_4 = 9600 \\
                       & Tables +Slack_5 = 200 \\
                       & Chairs, Desks, Tables, Slack_1, ..., Slack_5 \geq 0  
  \end{aligned}
  \end{split}
  (\#eq:Base_Model_Ex4)
$$

### Implementing a 3 Variable Standard Form LP
...
### Converting an Algebraic Model to Standard Form

Convert our generalized production planning LP into standard form.  Hint,  To do so, define a use variable, $s_j$ to reflect these changes and add it to the following formulation.   
