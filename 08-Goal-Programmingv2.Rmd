...
Now, let's examine the secpmd group's model that has an objective of maximizing the expected number of children served.\
...
```{r build-mail1-model, message=FALSE}
...
```{r Display-weekly-Mailings, results='asis', eval=FALSE}

kbl(as.matrix(table_results1[-1]), booktabs=T,
