...
& 3\cdot Ants + 10 \cdot Bats \leq 1200 \\
& Ants, Bats \geq 0  
  \end{aligned}
  \end{split}
$$
...
model0f<-add_constraint(model0e,2*Ants+2*Bats<= 480)  
  #testing
model0g<-add_constraint(model0f,3*Ants+12*Bats<=1200) 
  #sensors
...
#testing
model0<- add_constraint(model0, 3*Ants + 10*Bats <= 1200) 
#sensors
...
result0 <- MIPModel() %>%
  ...
  add_constraint(3*Ants + 10*Bats<= 1200) %>% #sensors
...
$$
 \begin{split}
 \begin{aligned}
    \text{Max  }   & 7\cdot Ants +12 \cdot Bats +8\cdot Cats \\
    \text{s.t.:} & \\
& 1\cdot Ants + 1\cdot Bats +2\cdot Cats \leq 800 \\
& 3\cdot Ants + 3\cdot Bats +2\cdot Cats \leq 900 \\
& 2\cdot Ants + 2\cdot Bats +4\cdot Cats \leq 480 \\
& 3\cdot Ants + 3\cdot Bats +2\cdot Cats \leq 1200 \\
...
model1 <- MIPModel() %>%
  ...
  add_constraint(1*Ants + 4*Bats + 2*Cats<=1000)%>% 
  #machining
  add_constraint(3*Ants + 6*Bats + 2*Cats<=1000)%>% 
  #assembly
  add_constraint(2*Ants + 2*Bats + 4*Cats<=720)%>% 
  #testing
  add_constraint(3*Ants + 10*Bats + 2*Cats<=1200)%>% 
  #sensors
...
$$
 \begin{split}
 \begin{aligned}
    \text{Max  }   & Profit=4\cdot Ants +2 \cdot Bats +8\cdot Cats \\
    \text{s.t.:} & \\
& 1\cdot Ants + 3 \cdot Bats  +2\cdot Cats \leq 1000 \\
& 3\cdot Ants + 4 \cdot Bats  +6\cdot Cats \leq 1000 \\
& 2\cdot Ants + 3 \cdot Bats  +4\cdot Cats \leq 720 \\
& 3\cdot Ants + 5 \cdot Bats  +6\cdot Cats \leq 1200 \\
& Ants, Bats, Cats \geq 0  
\end{aligned}
\end{split}
$$
...
model2a <- MIPModel() %>%
  ...
  set_objective(7*Ants + 2*Bats + 14*Cats,"max")%>%
  ...
  #testing
  add_constraint(3*Ants + 10*Bats + 6*Cats<=1200)
  #sensors
...
Let's try one more situation by adding instead forcing the number of Bats to be 120 and solving.
...
$$
 \begin{split}
 \begin{aligned}
    \text{Max  }   & Profit=7\cdot Ants +12 \cdot Bats +4\cdot Cats \\
    \text{s.t.:} & \\
& 1\cdot Ants + 4 \cdot Bats  +2\cdot Cats \leq 1000 \\
& 3\cdot Ants + 6 \cdot Bats  +2\cdot Cats \leq 1000 \\
& 2\cdot Ants + 2 \cdot Bats  +4\cdot Cats \leq 720 \\
& 3\cdot Ants + 10 \cdot Bats  +2\cdot Cats \leq 1200 \\
...
result4 <- MIPModel() %>%
 ...
 set_objective(7*Ants + 12*Bats + 8*Cats,"max")%>%
  
 add_constraint(1*Ants + 4*Bats + 1*Cats>= 800) %>%
    #machining
 add_constraint(3*Ants + 6*Bats + 1*Cats>= 900) %>% 
    #assembly
 add_constraint(2*Ants + 2*Bats + 2*Cats>= 480) %>%
    #testing
 add_constraint(3*Ants + 10*Bats + 2*Cats>= 1200)%>% 
    #sensors
