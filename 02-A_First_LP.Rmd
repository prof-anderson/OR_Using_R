...
Each of these packages plays a role.  As we discussed in the earlier chapter, pander makes for nicely formatted tables. The magrittr package gives us a piping function that simplifies model building.  The dplyr package is like a Swiss army knife for a providing a broad range of different data process tools.  
...
res2a <- cbind(get_solution(result2a, Profit),
...
res2b <- cbind(get_solution(result2b, Profit),
