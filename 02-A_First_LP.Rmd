...
model0d<-add_constraint(model0c,1*Ants+4*Bats<= 1000) 
  #machining
model0e<-add_constraint(model0d,3*Ants+6*Bats<= 900)  
  #assembly
model0f<-add_constraint(model0e,3*Ants+3*Bats<= 720)  
  #testing
model0g<-add_constraint(model0f,3*Ants+6*Bats<=1200) 
  #sensors
...
model0<- add_constraint(model0, 1*Ants + 4*Bats <= 1000) 
#machining
model0 <- add_constraint(model0, 3*Ants + 6*Bats <= 900) 
#assembly
model0<- add_constraint(model0, 2*Ants + 2*Bats <= 480) 
#testing
model0<- add_constraint(model0, 3*Ants + 9*Bats <= 1200) 
#sensors
...
model2a <- MIPModel() %>%
  ...
  add_constraint(1*Ants + 3*Bats + 2*Cats<=1000)%>% 
  #machining
  add_constraint(3*Ants + 4*Bats + 6*Cats<=1000)%>% 
  #assembly
  add_constraint(2*Ants + 3*Bats + 4*Cats<=720)%>% 
  #testing
  add_constraint(3*Ants + 5*Bats + 6*Cats<=1200)
  #sensors
