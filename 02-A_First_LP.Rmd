...
```{marginfigure}
There is a field of multiple-objective linear programming where multiple objectives or goals can be accommodated. This will be explored in Chapter 7.
```
...
```{r base_case_no_pipes_step_4, fig.fullwidth=TRUE}
