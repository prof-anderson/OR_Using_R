...
```
```{marginfigure}
Table 1: Two variable base case
```
...
```{marginfigure}
Table 2: Elements of the Constraints
```
...
```
```{marginfigure}
Table 3: Three variable base case
```
...
```
```{marginfigure}
Table 4: Results 2a - A First of Multiple Optima
```
...
```
```{marginfigure}
Table 5: Results 2b - A Second of Multiple Optima
```
...
```
```{marginfigure}
Table 6: Results 2c - A Second of Multiple Optima
```
...
and paints (or stains) the furniture. See Table 3 on the right.
...
```
```{marginfigure}
Table 8: Beginning of Sequence x1
```
...
```
```{marginfigure}
Table 9: Some datapoints from the lines for the constraints
```
