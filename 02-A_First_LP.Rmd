...
Again, a product mix is made but now instead and Ants and Bats,  is Ants instead of Bats with exactly the same level of profit. This is an instance of multiple optima. \vspace{12pt}

Let's try one more situation by adding instead forcing the number of Ants to be 60 and solving.
