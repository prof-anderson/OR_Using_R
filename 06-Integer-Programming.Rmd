...
rmarkdown::render("06-Integer-Programming.Rmd", "tufte_book2")
```
...
$$w_3 \leq min \{ \frac{1000}{3}, \frac{2000}{2}, \frac{1000}{1}, \frac{1500}{1}, 750 \}=333.3$$ \vspace{12pt} Since the Big M value is setting a lower bound, in this way, we can round up from 333.33 to 334. Our updated model with "Big M":
