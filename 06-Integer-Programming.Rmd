...
$$
 ...
 \begin{aligned}
    ...
    \text{s.t.  } & 1.0 x_1 + 3.0 x_2 \leq 8.25 \\
...
```{r Fig-LP-Feasible-Region, echo=FALSE, out.width="49%", fig.show='hold', fig.align='center', fig.cap="LP Region and 11 IP Feasible Solutions" }
...
The Branch and Bound process is often characterized as a tree.  
```{r Fig-B-and-B-Summary, echo=FALSE, fig.align='center', fig.show='hold', out.width="4in", fig.cap="Branch and Bound Tree"}
...
In our example, we need to connect or *link* the two decision variables of how much to produce and whether to produce for each of the products.^[This example is based on an example from Thanh Thuy Nguyen.]\  
...
Objective Function:  Maximize profit \vspace{12pt}
...
+-------------------+--------------------------+-------------------------------------------------------------------------------------+
| Amount to produce | Decision to produce      | Interpretation of situation                                                         |
|                   |                          |                                                                                     |
| $w_1$             | $y_1$                    |                                                                                     |
+===================+==========================+=====================================================================================+
...
Consider adding a new widget 4 which needs 4, 3, 2, and 5 hours for Pre-processing, 
Machining, Assembly, and Quality Assurance respectively. Widget 4 uses the same setup as Widget 3 which means no repeated setup cost for Widget 4 if widget 3 is already being produced.
