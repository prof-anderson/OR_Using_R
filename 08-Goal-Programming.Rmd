...
```{r Solve_glpk_gap15 }
res_Mail1a <- solve_model(Mail1, 
                        with_ROI(solver = "symphony",
                   verbosity=-1, gap_limit=0.0))
```
