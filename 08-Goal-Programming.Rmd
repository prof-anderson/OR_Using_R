...
ITSI has a variety of staff with different skill sets, pay rates, preferences, and scheduling requests.  Jane is the Director of ITSI and wants to find a good schedule of workers.  \vspace{12pt}
...
Next let's constraints and formulate them in terms of the decision variables. We have two constraints. The first one for the budget is simply: $20 \cdot H+ 10\cdot R \leq 1000$ 
...
sum_Home5           <- cbind(res_Home5$objective_value,H, R, d1, d1/T1, d2, d2/T2)
colnames(sum_Home5) <- c("Obj. Func. Val.", "H", "R", "d1", "d1%", "d2", "d2%")
