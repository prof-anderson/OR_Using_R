...
grid.table(chair_res_used)
```
```{marginfigure}
**Table 4.5**: Resources Used by a Chair and their Shadow Prices
```
...
grid.table(desk_res_used)
```
```{marginfigure}
**Table 4.6**: Resources Used by a Desk and their Shadow Prices
```
...
```
```{marginfigure}
**Table 4.7**: Resources Used by a Table and their Shadow Prices
```
...
```
```{marginfigure}
**Table 4.8**: Production Plan with Table Set to One
```
\vspace{12pt}
...
```
```{marginfigure}
**Table 4.9**: Impact of a Forced Change in Tables
```
