...
grid.table(format(table_res_used, digits=4))
```
```{marginfigure}
...
```
\vspace{12pt}
Let's compare the results for the new production plan and the original base case looking at the Table 4.10.  
