...
We can get a lot more than just the objective function value and the decision variable values from a solved linear program. In particular, we can potentially lexplore the impact of changes in constrained resources, changes in the objective function, forced changes in decision variables, and the introduction of additional decision variables.
...
**Exercise 3.1** (Revisiting Transportation)
