...
```{r Fig-LaTeX_blank_line1, echo=FALSE,  out.width='100%', fig.cap="Preview Ignores Blank LaTeX Line" }
...
```{r Fig-LaTeX_blank_line2, echo=FALSE, out.width='100%', fig.cap="Rendering Error Caused by Blank LaTeX Line"}
...
Miscellaneous PDF and LaTeX Issues

Knitting to PDF uses the LaTeX environment so a variety of other issues may arise..
...
```{r Fig-piping-error0, echo=FALSE, out.width="4in", fig.cap="Name conflict error between R and `ompr`"}
...
```{r Fig-piping-error1, echo=FALSE, out.width="4in", fig.cap="R's Inability to Source of Error when Piped"}
...
```{r Fig-piping, echo=FALSE,  out.width='100%'}
...
```{r Fig-piping-error2, echo=FALSE, out.width="4in"}
#  fig.cap='Initial error message generated by using a variable in ompr that is also defined outside ompr.',
...
```{r Fig-undefined_object, echo=FALSE, out.width='100%'}
#  fig.cap='Initial error message generated by using a variable in ompr that is also defined outside ompr.',
...
```{r Fig-unexpected-symbol, echo=FALSE,  out.width='100%'}
#  fig.cap='Initial error message generated by using a variable in ompr that is also defined outside ompr.',
...
```{r Fig-ompr-var1, echo=FALSE, out.width="4in", fig.cap="Error Due to Name Conflict between R and `ompr`"}
