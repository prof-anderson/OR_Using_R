...
```{r Fig-piping-error1, echo=FALSE, out.width="4in", fig.cap="Inability to Focus on Error Source in a Piped Model."}
...
```{r Fig-piping-error2, echo=FALSE, out.width="4in", fig.cap="Finding an Error in an Unpiped Model."}
#  fig.cap='Initial error message generated by using a variable in ompr that is also defined outside ompr.',
