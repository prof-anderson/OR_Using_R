...
These vignettes can be viewed from the package documentation, Dirk's github web [site](https://dirkschumacher.github.io/ompr/articles/index.html), or downloading his github repository.
...
This is a known issue in `ompr` and `ompr.ROI`as of version 0.8.0.0.
