...
Let's change the time required for painting an ant to 20.
...
In our example, we might say that Ants can make up no more than 40% of the overall product plan.
...
$$
 ...
 \begin{aligned}
    \text{Max:} & \\
                & 20 \cdot Ants+14 \cdot Bats+16 \cdot Cats \\
    \text{S.t.} & \\
                       & 6 \cdot Ants+2 \cdot Bats+4 \cdot Cats \leq 2000 \\
                       & 8 \cdot Ants+6 \cdot Bats+4 \cdot Cats \leq 2000 \\
                       & 6 \cdot Ants+4 \cdot Bats+8 \cdot Cats \leq 1440 \\
                       & 40 \cdot Ants+25Bats+16Cats \leq 9600 \\
                       & 0.6 \cdot Ants-0.4 \cdot Bats-0.4 \cdot Cats \leq 0 \\
                       & Cats \leq 200 \\
