...
```{r Display_Resources_and_Available}
...
Formulate a generalized model for the above application that solves this transporation problem to find the lowest cost way of transporting as much as product as we can to distributors. (Hint: Feel free to use my LaTeX formulation for the general transportation model and make change(s) to reflect your case.  
