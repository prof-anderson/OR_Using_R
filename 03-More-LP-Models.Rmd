...
Specific blend limitations arise in many situations.  In our example, we might say that Chairs can make up no more than 40% of the overall product plan.  In our original case, this would be expressed as the following.  
\vspace{12pt}
$$
 \begin{split}
 \begin{aligned}
...
```
The table on the right displays the optimal production plan for the original formulation without the limit on production of chairs. 
\vspace{12pt}

Let's add the constraint that chairs can't make up more than 40% of the total production.  \vspace{12pt}
...
```{r Display_3Var_Objective_Function}
