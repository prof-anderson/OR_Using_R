...
```{marginfigure}
Using inline code is a great part of RMarkdown.  In the text of your RMarkdown, anything enclosed by a pair of single tick marks will be shown as a code chunk.  If it starts with the letter r, it will be passed instead to R for evaluation. This allows for both discussing reproducible results.
```
