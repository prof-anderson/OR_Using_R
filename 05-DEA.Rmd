...
dimnames(results.lambda)<-list(DMUnames,Lambdanames)
kbl (cbind(results.efficiency, results.lambda),
     booktabs=T, digits=4, caption="Input-Oriented Model with  
...
```{r DEA-DRS-Frontier-Plot, echo=FALSE, fig.margin=TRUE, fig.height=4, fig.cap="Decreasing  (Non-Increasing) Returns to Scale Efficiency Frontier"}
library(Benchmarking, quietly=TRUE)
