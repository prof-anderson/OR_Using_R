...
```{r DEA-Isoquant-Plot, fig.margin=TRUE, fig.height=4}
...
kbl(cbind(results.efficiency, results.lambda),
    booktabs=T, escape=F, caption=
      "Input-Oriented Envelopment Analysis for DMU B (CCRIO)")
```
...
dimnames(results.lambda)<-list(DMUnames,Lambdanames)
kbl (cbind(results.efficiency, results.lambda),
     booktabs=T, caption="Input-Oriented Model with  
...
dimnames(results.lambda)<-list(DMUnames,Lambdanames)
kbl (cbind(results.efficiency, results.lambda), 
     booktabs=T, escape=F, caption="Input-Oriented Increasing Returns 
...
kbl (cbind(eff.crs, eff.vrs, eff.drs, eff.irs), 
     booktabs=T, caption="Comparison of Efficiency under 
...
kbl (c(res.vweight[k,],res.uweight[k,]), booktabs=T,
...
kbl (cbind(res.efficiency, res.vweight, 
              res.uweight), booktabs=T, digits=6, 
