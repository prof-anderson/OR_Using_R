...
Let's start by creating a simple dataset. Let's assume that you are a regional manager of a grocery chain.  You have four stores and would like to assess the performance of the store managers using number of employees, _x_, as an input and the weekly sales, _y_, as an output. 
\vspace{12pt}

As the manager responsible for the stores in the region, there are many questions that we may want answered:

* We are interested in questions such as which of these stores are the best?  
