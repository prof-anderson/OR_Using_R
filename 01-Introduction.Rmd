...
Now, we have several options to draw a table. We could use the `kable` , `grid.table`, `huxtable`, `dt`, or many others but for now we'll use one of the simplest, `pander` .
