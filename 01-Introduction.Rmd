...
Considering top selling online products for year 2021: Toys, Shoes, Pens and pencils, Decorative bottles, Drills, Cutters, GPS navigation systems. Create your own assumed starting counts per item for throughout year by increasing each item sales by 50 units per month, starting from January till December.
:::
...
In the above matrix, demand for toys and shoes has been increased by 20 and 10 units respectively. Create a matrix for only these products for first 6 months. Display the matrix twice once without formatting and a second time using package better table formatting (`pander`, `kable` via `knitr`, or other formatting table method.)
:::
