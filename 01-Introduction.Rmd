...
Notice that we only needed to tell R that the matrix has four columns and it then knew that there two rows.  We could have set the number of rows to be two for the same result.  \vspace{12pt}
...
\vspace{12pt}
And Table 1.11 will use rows as bindding condition.
